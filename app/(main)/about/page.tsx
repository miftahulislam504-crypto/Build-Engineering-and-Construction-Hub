...
export const metadata: Metadata = {
  title:       "About Us | BuildMart BD",
  description: "Learn about BuildMart BD — Bangladesh's leading civil engineering construction materials and services marketplace.",
};
      ...
      <div className="bg-gradient-to-br from-primary-900 to-primary-700 text-white py-20">
        <div className="container-main text-center">
          ...
          <p className="text-primary-100 text-base max-w-2xl mx-auto leading-relaxed">
            BuildMart BD is a one-stop marketplace connecting construction professionals,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-dark-500 text-sm leading-relaxed mb-5">
                ...
                at fair prices. BuildMart BD was founded to eliminate the complexity of
