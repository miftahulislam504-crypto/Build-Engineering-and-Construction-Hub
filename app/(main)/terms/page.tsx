...
export const metadata: Metadata = {
  title:       "Terms & Conditions | BuildMart BD",
  description: "Read BuildMart BD's terms and conditions governing the use of our marketplace platform.",
};
      ...
      <div className="container-main max-w-4xl py-12">
        <div className="space-y-8">
          ...
          <Section title="1. Acceptance of Terms">
            <p>
              By accessing and using the BuildMart BD website and services, you accept
          ...
          <Section title="7. Engineering Services">
            <ul>
              ...
              <li>BuildMart BD acts as a marketplace; individual service providers are responsible for their work quality</li>
          ...
          <Section title="10. Intellectual Property">
            <p>
              All content on BuildMart BD — including logos, images, text, and software — is
              the property of BuildMart BD and protected by applicable intellectual property laws.
          ...
          <Section title="11. Disclaimer of Warranties">
            <p>
              BuildMart BD provides its services &quot;as is&quot; without warranties of any kind.
          ...
          <Section title="12. Limitation of Liability">
            <p>
              To the maximum extent permitted by law, BuildMart BD shall not be liable for
          ...
          <Section title="14. Contact Information">
            ...
            <div className="card p-5 bg-dark-50 mt-4">
              <div className="space-y-2 text-sm text-dark-600">
                ...
                <p>Email: legal@buildmartbd.com</p>
