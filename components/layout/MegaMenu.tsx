    ...
    children: [
      {
        ...
        slug: "cement",
        icon: "🏗️",
        brands: ["Holcim", "Shah Cement", "Crown Cement"],
      },
      {
        label: "Steel",
        slug: "steel",
        icon: "⚙️",
        brands: ["BSRM", "GPH Ispat", "KSRM"],
      },
      {
        label: "Paint",
        slug: "paint",
        icon: "🎨",
        brands: ["Berger", "Asian Paints", "Elite Paint", "Rainbow Paint"],
      },
      {
        label: "Electrical",
        slug: "electrical",
        icon: "⚡",
        brands: ["BRB Cable", "Bizli Cable", "Super Star", "SQ Group"],
      },
      {
        label: "Sanitary & Bathroom",
        slug: "sanitary-bathroom",
        icon: "🚿",
        brands: ["Kohler", "Grohe", "Shine", "Bengal Sanitary"],
      },
      {
        label: "Chemical & Waterproofing",
        slug: "chemical-waterproofing",
        icon: "🧪",
        brands: ["Sika", "Dr Fixit"],
      },
      {
        label: "Tile & Ceramics",
        slug: "tile-ceramics",
        icon: "🔲",
        brands: ["RAK Ceramics", "Akij Ceramics", "Great Wall"],
      },
      {
        label: "Doors & Windows",
        slug: "doors-windows",
        icon: "🚪",
        brands: ["Bashundhara", "RFL"],
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        slug: "bricks",
        icon: "🧱",
        brands: ["First Class Brick", "Picked Brick", "Fly Ash Brick"],
      },
      {
        label: "Sand",
        slug: "sand",
        icon: "⛱️",
        brands: ["Fine Sand", "Medium Sand", "Sylhet Sand"],
      },
      {
        label: "Stone Chips",
        slug: "stone-chips",
        icon: "🪨",
        brands: ["20mm Chips", "10mm Chips"],
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        icon: "🦺",
        brands: ["Safety Helmet", "Safety Gloves", "Safety Vest", "N95 Mask", "Normal Mask"],
      },
      {
        label: "Tools & Equipment",
        slug: "tools-equipment",
        icon: "🔧",
        brands: ["Rope", "Measuring Tape", "Wheelbarrow", "Shovel", "Spade", "Broom"],
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        icon: "✏️",
        brands: ["Architectural Design", "Structural Design", "Electrical Design", "Plumbing Design"],
      },
      {
        label: "Construction Services",
        slug: "construction-services",
        icon: "🏢",
        brands: ["Building Construction", "Renovation", "Interior Works", "Project Supervision"],
      },
      {
        label: "Consultancy Services",
        slug: "consultancy-services",
        icon: "📋",
        brands: ["BOQ Preparation", "Estimation & Costing", "Project Planning", "Site Inspection"],
      },
      {
        label: "Survey Services",
        slug: "survey-services",
        icon: "🗺️",
        brands: ["Land Survey", "Topographic Survey", "Setting Out"],
      },
    ],
  },
];
